  ...
  return (
    <form className="grid grid-cols-4 gap-4 mt-2 mb-2 controlDate">
        ...
        <div>
            ...
            <select className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                <option>Please select</option>
                <option value="Gir Jungle Trail">Gir Jungle Trail</option>
                <option value="Devalia Safari">Devalia Safari</option>
                <option value="Kankai Temple Safari">Kankai Temple Safari</option>
            </select>
        </div>
        <div>
