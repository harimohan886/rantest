...
export default function PackageAssets() {
  return (
    <table className='table bg-white border border-slate-300 mt-4'>
        ...
        <tbody>
            <tr>
                ...
                <td className='border border-slate-300 text-left'>Complimentary use of recreational activities in resort premises.</td>
                ...
                <td className='border border-slate-300 text-left'>
                    <Link to='/admin/edit-package-assets' className="text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:outline-none focus:ring-green-300 font-medium rounded-lg text-sm p-2.5 text-center inline-flex items-center mr-2 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800">
                        <i className="fas fa-pencil"></i>
                    </Link>
                    <button className="text-white bg-red-700 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 font-medium rounded-lg text-sm p-2.5 text-center inline-flex items-center mr-2 dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-800">
