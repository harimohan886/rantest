        ...
        <div className="w-full mb-12 xl:mb-0 px-4 padding-top80">
            ...
            <form>
                <div className='form-group'>
                    ...
                    <input type="text" id="accountName" onChange = {(e) => setName(e.target.value)} value = {name} placeholder='Account name' className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" required="" />
                </div>
                <div className='form-group'>
                    <label className="block mb-2 text-sm font-bold text-gray-900 dark:text-gray-300">Email</label>
                    <input type="text" id="accountEmail" onChange = {(e) => setEmail(e.target.value)} value = {email}  placeholder='Account email' className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" required="" />
                </div>
                <div className='form-group'>
