      ...
      <div className="flex flex-wrap min600">
        <div className="w-full mb-12 xl:mb-0 px-4 padding-top80">
            <div className="grid grid-cols-2 gap-4">
                ...
                <div className='mt-4'>
                    <Link to='/admin/add-room' type="submit" className="text-white float-right bg-success font-medium rounded px-5 py-2.5 text-center">Add Room</Link>
                </div>
            </div>
            <table className='table bg-white border border-slate-300 mt-4'>
                ...
                <tbody>
                    <tr>
                        ...
                        <td className='border border-slate-300 text-center'>
                            <Link to='/admin/edit-room' className="text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:outline-none focus:ring-green-300 font-medium rounded-lg text-sm p-2.5 text-center inline-flex items-center mr-2 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800">
