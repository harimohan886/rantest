...
export default function CreatePackageCanecllationPolicy() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const res = await axios.post(`${process.env.REACT_APP_BASE_URL}/package/cancellation-policies/`, data);
        ...
        <div className="relative md:ml-64 bg-default-skin">
            ...
            <div className="flex flex-wrap min600">
                <div className="w-full mb-12 xl:mb-0 px-4 padding-top80">
                    <div className='mt-4'>
                        <h1 className='text-2xl text-black font-bold mb-3'>Add Canecllation Policy</h1>
                    </div>
                    <div className="mb-3">
