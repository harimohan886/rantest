...
export default function EditFestivalDates() {
    ...
    const HandleSubmit = () => {
        ...
        axios.post(`${process.env.REACT_APP_PACKAGE_SERVER_URL}/blockdate/update-block-date/${params.id}`, data, {
            headers: {
    ...
    useEffect(() => {
        ...
        axios.get(`${process.env.REACT_APP_PACKAGE_SERVER_URL}/blockdate/get-block-date/${params.id}`).then((res) => {
        ...
        <div className="relative md:ml-64 bg-default-skin">
            ...
            <div className="flex flex-wrap min600">
                <div className="w-full mb-12 xl:mb-0 px-4 padding-top80">
                    <div className='mt-4'>
                        <h1 className='text-2xl text-black font-bold mb-3'>Edit Block Date</h1>
                    </div>
                    <form>
