        ...
        <div className="w-full mb-12 xl:mb-0 px-4 padding-top80">
          ...
          <form onSubmit={handleSubmit}>
            <div className="mb-6">
              ...
              <input type="text" id="amenity" onChange={(e) => setAmenity(e.target.value)} value={amenity} className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" required />
            </div>
            <div className='mb-6'>
